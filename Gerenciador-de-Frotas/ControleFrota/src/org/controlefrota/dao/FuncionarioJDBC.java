...
public class FuncionarioJDBC implements FuncionarioDAO{
	...
	public void inserir(Funcionarios dado) {
		try {
			...
			statement.setString(10,dado.getmuni_codigo());
			statement.setString(11, dado.getmuni_uf());
	...
	public void alterar(Funcionarios dado) {
		try {
			String sql = "update funcionarios set nome = ?,cpf =?, rg = ?,ctps = ?,dtnacimento = ?"
					+ "endereco = ?, endnumero = ?,bairro = ?, cep = ?, muni_codigo = ?,muni_uf = ?"
	...
	public List<Funcionarios> listar() {
		...
		try {
			...
			funcionario.setendnumero(rs.getString("endnumero"));
			funcionario.setmuni_codigo(rs.getString("muni_codigo"));
			funcionario.setmuni_uf(rs.getString("muni_uf"));
